...
class _CovidApi implements CovidApi {
  ...
  @override
  Future<List<CountryVO>> getCountry() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<CountryVO>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => CountryVO.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<List<ByCountryAllStatusVO>> getAllStatusByCountry(
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<ByCountryAllStatusVO>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            ByCountryAllStatusVO.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
